    ...
    <div>
        ...
        <section className="text-white">
            <div className="container py-5">
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        <img src="./Images/return-to-sj.jpg" alt="Earthquakes Fans" className="img-fluid rounded" />
                    </div>
                </div>
            </div>
        </section>
        ...
        <section className="text-white">
            <div className="container py-5">
                <div className="row">
                    <div className="col-lg-6">
                        <h3 className="text-decoration-underline fw-bold pb-2">Return and Recent Success</h3>
                        <p>In 2014, the San Jose Earthquakes returned to their rightful home with the opening of the newly built PayPal Park Stadium. The dedicated soccer-specific venue became the centerpiece of the club's revitalization efforts.</p>
        ...
        <section className="text-white">
            <div className="container py-5">
                <div className="row">
                    <div className="col-lg-6">
                        <img src="./Images/luchi.jpg" alt="Luchi Gonzalez, holding up a Quakes scarf" className="img-fluid rounded" />
                    </div>
                    <div className="col-lg-6">
                        <h3 className="text-decoration-underline fw-bold pb-2">Current Status and Future Outlook</h3>
                        <p>Today, the San Jose Earthquakes are vibrant and competitive club under the Guidance of Head Coach Luchi Gonzalez & General Manager Chris Leitch. They continue to build a strong foundation and strive for success on all fronts.</p>
                        <p>The Earthquakes have a passionate and dedicated multiple fan bases, the biggest group known as the "Quakes Ultras" other smaller groups like "The Faultline" and "Seismic Union | Union Sismica". These groups bring high energy and excitement to every home game on the North and South supporter sections at PayPal Park. The club's focus on community engagement and youth development programs has further solidified it's position as a sports institution in San Jose.</p>
                        <p>With their storied history, passionate fan base, and a commitment to excellence, the San Jose Earthquakes look forward to a bright future and many more memorable moments on and off the pitch.</p>
                    </div>
                </div>
            </div>
        </section>
